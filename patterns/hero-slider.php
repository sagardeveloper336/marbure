...
<div class="wp-block-group alignfull marbure-hero-section has-white-color has-text-color" style="background-color:#0A1E3F;padding-top:120px;padding-bottom:120px;padding-left:2rem;padding-right:2rem">
	...
	<p class="has-text-align-center has-text-color" style="color:#CF9776;font-size:0.8125rem;font-style:normal;font-weight:600;letter-spacing:0.12em;text-transform:uppercase">12 Years of Legal Excellence</p>
	<!-- /wp:paragraph -->
	...
	<h1 class="wp-block-heading has-text-align-center has-text-color has-heading-font-family" style="color:#ffffff;font-size:clamp(2.25rem,5vw,3.75rem);font-weight:700;line-height:1.15">Fighting for Your Justice</h1>
	<!-- /wp:heading -->
	...
	<p class="has-text-align-center has-text-color" style="color:#cbd5e1;font-size:1.125rem;line-height:1.7;margin-top:1.25rem;margin-bottom:2.5rem">Experienced attorneys committed to protecting your rights and securing the justice you deserve. Initial consultations are always free.</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background wp-element-button" href="/contact" style="background-color:#CF9776;color:#ffffff;border-radius:4px;padding-top:0.875rem;padding-bottom:0.875rem;padding-left:1.75rem;padding-right:1.75rem">Free Consultation</a></div>
		<!-- /wp:button -->
		...
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-text-color wp-element-button" href="/practice-areas" style="color:#ffffff;border-radius:4px;border-color:#ffffff;border-width:2px;padding-top:0.875rem;padding-bottom:0.875rem;padding-left:1.75rem;padding-right:1.75rem">Our Practice Areas</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
