...
/**
 * Title: About Intro
 * Slug: marbure/about-intro
 * Categories: featured
 * Description: Two-column about section with image, mission statement, and key metrics.
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"5rem","bottom":"5rem","left":"2rem","right":"2rem"},"blockGap":"3rem"}},"className":"marbure-about-section"} -->
<div class="wp-block-group alignfull marbure-about-section" style="padding-top:5rem;padding-bottom:5rem;padding-left:2rem;padding-right:2rem">

	<!-- wp:columns {"align":"wide","isStackedOnMobile":true,"style":{"spacing":{"blockGap":"3rem"}}} -->
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<div class="wp-block-columns" style="margin-top:2rem">
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"3rem","fontWeight":"700"},"color":{"text":"#CF9776"}},"fontFamily":"heading"} -->
					<h3 class="wp-block-heading has-text-color has-heading-font-family" style="color:#CF9776;font-size:3rem;font-weight:700">12+</h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph {"style":{"color":{"text":"#0A1E3F"},"typography":{"fontWeight":"600"}}} -->
					<p class="has-text-color" style="color:#0A1E3F;font-weight:600">Years Experience</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:column -->
