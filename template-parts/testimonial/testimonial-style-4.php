 ...
 * Bold gradient background, 2-per-view cards with nav arrows and pagination.
 *
 * @package marbure
 */
...
?>
<section class="section testimonials-section testimonials-style-4">
	<div class="container">
		...
		<div class="swiper js-testimonials-swiper"
			...
			<div class="testimonials-style-4__controls">
				<div class="swiper-button-prev testimonials-swiper__prev" aria-label="<?php esc_attr_e( 'Previous', 'marbure' ); ?>"></div>
				<div class="swiper-pagination testimonials-swiper__pagination"></div>
				<div class="swiper-button-next testimonials-swiper__next" aria-label="<?php esc_attr_e( 'Next', 'marbure' ); ?>"></div>
			</div>
		</div><!-- .swiper -->
